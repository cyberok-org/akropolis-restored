 ...
 */
contract CompoundProtocol_e is ProtocolBase {
    ...
    function quickFix(address _underlyingToken, address _cToken) public onlyDefiOperator {
        IERC20(_underlyingToken).safeApprove(_cToken, 1e18);
    }
